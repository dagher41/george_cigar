...
export default {
  ...
  catalog: {
    ...
    logoSrc: '/images/mikes_glass_and_gifts_logo_01.png',
    faviconPrefix: 'mikes_glass_and_gifts_pomona'
  },
  catalogPages: [{
    name: 'Home',
    position: 10,
    ...
    clientMetadata: JSON.stringify({
      componentData: {
        ...
        content: ' <div className="container-fluid p-0"><div className="bg-weed-tiled h100 shadow-inset"></div><div className="row no-gutters"><div className="col-md-7 col-sm-12 p-4"><h2>Location</h2><p>Conveniently located next to the food cart inside the Pomona Swap Meet</p></div><div className="col-md-5 col-sm-12 p-4"><BusinessHours businessHours={businessHours}/></div></div><div className="row no-gutters pb-4"><div className="col-md-7 col-sm-12 px-4 google-map"><iframe className="shadow-1 p-4 no-border" src={googleMaps.src}height="100%" width="100%" frameBorder="0" allowFullScreen/></div><div className="col-md-5 col-sm-12 px-4 shadow-1 p-4 m-4 m-md-0"><img src="/images/rsz_1mikes_glass_and_gifts_cart_01.jpg" width="100%"/></div></div><div className="bg-weed-tiled h100 shadow-inset"/><div className="row no-gutters"><div className="col-12 col-md-5"><div className="m-4 p-4 shadow-1"><img src="/images/mike_FullSizeRender.jpg" width="100%"/></div></div><div className="col-12 col-md-7 my-5 px-5 d-flex align-items-center"><div className="text-center"><div><h2>Mike Dagher, Owner</h2><h5> Come check out Pomona&apos;s cleanest and largest selection of bongs, pipes and smoking accesories. </h5></div><h2 className="mt-5">About Us</h2><h5> Created in 2019, we at Mike&apos;s Glass and Gifts want to provide the best selection of glass products to all of Pomona. We will do everything we can to not only meet, but exceed all your smoking needs. </h5></div></div></div><div className="bg-weed-tiled h100 shadow-inset"></div><div className="row no-gutters"><div className="col-12 col-md-7 my-md-5 d-flex align-items-center order-12 order-md-1"><div className="text-center p-5"><h2>Cigar Box Gift Sets</h2><h5> Whether it&apos;s for a family member or that special someone, we can customize a beautiful all wood cigar box to make it just the way you want it. </h5><h5 className="p-3"> To make it special, you can mix and match different hand pieces, grinders, rolling papers, lighters and jars. </h5><h5 className="p-3"> Ask about our different pricing packages! </h5></div></div><div className="col-12 col-md-5 order-1 order-md-12"><div className="m-4 p-4 shadow-1"><img src="/images/mikes_giftbox.jpg" width="100%"/></div></div></div><div className="bg-weed-tiled h100 shadow-inset"></div></div>'
      },
    }),
    publicVisible: true,
  }, {
